...
public class p_prize {
    ...
    public p_prize(Integer prizeId, String prizeName, String prizeImage, Integer prizeAmount, Integer prizePrice, Integer prizeQuota, Integer prizeCondition, Integer prizeStatus, Integer prizeBuy) {
