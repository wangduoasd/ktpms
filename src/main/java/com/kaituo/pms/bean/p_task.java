...
public class p_task {
    ...
    public p_task(Integer taskId, String taskName, Integer taskDifficulty, Integer taskPrice, Integer taskAward, Integer taskNumber, Integer taskTime, Date taskStarttime, Date taskEndtime, String taskImage, String taskDescribe, Integer taskStatus, Integer userId, String userName) {
        this.taskId = taskId;
