...
public class p_integral {
    ...
    public p_integral(Integer integralId, Integer userId, Integer integralStartnum, String integralChangestr, Date integralTime, Integer integralChangeint, Integer integralOperator, Integer integralEndnum) {
